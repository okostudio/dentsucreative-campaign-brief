...
const ScrollReveal = (props) => {
    ...
    useGSAP(
        ...
        () => {
            gsap.context(() => {
                let split = SplitText.create(".split-text", { type: "lines,words,chars", linesClass: "line line++", wordsClass: "word", charsClass: "char", overflow: "hidden" })

                if (isMobile) {
                    SplitText.create(".split-text", { type: "lines", linesClass: "line line++", overflow: "hidden" })
                }
                ...
                switch (props.type) {
                    case "basic":
                        ...
                        if (isMobile) {
                            tl.from(split.lines, { duration: 1, ease: "power3.out", color: "#222", stagger: { amount: 3 } }, "<0")
                        } else {
                    ...
                    case "random":
                        ...
                        if (isMobile) {
                            tl.from(split.lines, { duration: 1, ease: "power3.out", color: "#222", rotateX: 120, opacity: 0, stagger: { amount: 3 } }, "<0")
                        } else {
